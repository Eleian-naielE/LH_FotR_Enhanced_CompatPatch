...
function CISHeroes:new(gc, id)
	...
	space_data = {
		...
		full_list = { --All options for reference operations
			...
			["TJ912"] = {"TJ912_ASSIGN",{"TJ912_RETIRE"},{"TJ912_RECUSANT"},"TJ-912"}, -- FotR_Enhanced
			["TM171"] = {"TM171_ASSIGN",{"TM171_RETIRE"},{"TM171_DH_OMNI"},"TM-171"}, -- FotR_Enhanced
		},
	...
	ground_data = {
		...
		full_list = { --All options for reference operations
			...
			["Dassyne"] = {"DASSYNE_ASSIGN",{"DASSYNE_RETIRE"},{"DASSYNE_CA_ARTILLERY"},"Oro Dassyne", ["Companies"] = {"DASSYNE_CA_ARTILLERY_TEAM"}}, -- FotR_Enhanced
		},
		available_list = {--Heroes currently available for purchase. Seeded with those who have no special prereqs
			"Tendir",
			"TA175",
